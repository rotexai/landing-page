...
export const copy = {
  en: {
    nav: {
      valueProps: 'Capabilities',
      howItWorks: 'How It Works',
      differentiators: 'Why RotexAI',
    ...
    differentiators: {
      ...
      comparisonRows: [
        ...
        ['Task assignment', 'Manually assigned', 'Agents configured for tasks', 'Recommends the best resource'],
        ['Matching', 'Roles and profiles', 'Agent capabilities', 'Task needs, cost, risk, and outcomes'],
        ['Workflow', 'Spread across tools', 'Separate agent workflows', 'One shared Human-AI workflow'],
        ['Governance', 'Roles and approvals', 'Agent access and permissions', 'Permissions, approvals, and human oversight'],
        ['Measurement', 'Human productivity', 'Agent usage and performance', 'Cost, speed, quality, reliability, and results'],
      ],
    },
    marketplace: {
      ...
      illustration: {
        ...
        fit: '92% fit',
        query: 'Launch a governed customer support workflow',
        chips: ['Compliance', 'Customer Ops', 'AI Agent', 'Human Review'],
        resources: [
          ['Human Expert', 'Policy reviewer'],
          ['AI Agent', 'Ticket classifier'],
        ],
        insights: [
          ['Capability', 'Language, policy, routing'],
          ['Governance', 'Approval before escalation'],
          ['Hybrid Team', 'Human + AI agent assigned'],
        ],
      },
      items: [
        {
    ...
    pricing: {
      ...
      tiers: [
        {
          name: 'Starter',
          tagline: 'For teams trying RotexAI on their first workflow.',
          priceLabel: 'Free to start',
          ctaLabel: 'Get Started',
          features: ['1 active workspace', 'Human and AI capability matching', 'Basic workflow governance', 'Community support'],
        },
        {
          name: 'Pro',
          tagline: 'For teams running multiple workflows and resources.',
          priceLabel: 'For growing teams',
          ctaLabel: 'Get Started',
          features: ['Multiple workspaces', 'Human-Agent team recommendations', 'Advanced approvals and audit trails', 'Priority support'],
        },
        {
          name: 'Enterprise',
          ...
          ctaLabel: 'Contact Us',
          features: ['Unlimited workspaces', 'Custom governance rules', 'Dedicated onboarding', 'Enterprise support'],
        },
      ],
    },
    contact: {
      ...
      copyright: '© 2026 RotexAI Human-AgentOS. All rights reserved.',
    },
  },
  vi: {
    nav: {
      ...
      differentiators: 'Vì sao RotexAI',
      marketplace: 'Marketplace',
      pricing: 'Bảng giá',
    ...
    differentiators: {
      ...
      comparisonRows: [
        ...
        ['Cách giao việc', 'Giao thủ công', 'Agent được cấu hình cho từng task', 'Đề xuất nguồn lực phù hợp nhất'],
        ['Matching', 'Vai trò và hồ sơ', 'Năng lực của agent', 'Nhu cầu task, chi phí, rủi ro và outcome'],
        ['Workflow', 'Rải rác qua nhiều công cụ', 'Workflow agent tách riêng', 'Một workflow Human-AI dùng chung'],
        ['Governance', 'Vai trò và phê duyệt', 'Quyền truy cập và permission của agent', 'Permission, phê duyệt và human oversight'],
        ['Đo lường', 'Năng suất con người', 'Usage và hiệu suất của agent', 'Chi phí, tốc độ, chất lượng, độ tin cậy và kết quả'],
      ],
    },
    marketplace: {
      ...
      illustration: {
        ...
        fit: '92% hợp',
        query: 'Khởi chạy workflow hỗ trợ khách hàng có governance',
        chips: ['Compliance', 'Customer Ops', 'AI Agent', 'Human Review'],
        resources: [
          ['Human Expert', 'Policy reviewer'],
          ['AI Agent', 'Ticket classifier'],
        ...
        insights: [
          ['Capability', 'Ngôn ngữ, chính sách, routing'],
          ['Governance', 'Phê duyệt trước escalation'],
          ['Hybrid Team', 'Người + AI agent được giao'],
        ],
      },
      items: [
        {
    ...
    pricing: {
      ...
      tiers: [
        {
          name: 'Starter',
          tagline: 'Cho team thử RotexAI với workflow đầu tiên.',
          priceLabel: 'Bắt đầu miễn phí',
          ctaLabel: 'Bắt đầu',
          features: ['1 workspace active', 'Matching năng lực người và AI', 'Governance workflow cơ bản', 'Hỗ trợ cộng đồng'],
        },
        {
          name: 'Pro',
          tagline: 'Cho team chạy nhiều workflow và nguồn lực.',
          priceLabel: 'Cho team đang tăng trưởng',
          ctaLabel: 'Bắt đầu',
          features: ['Nhiều workspace', 'Đề xuất Human-Agent team', 'Phê duyệt và audit trail nâng cao', 'Hỗ trợ ưu tiên'],
        },
        {
          name: 'Enterprise',
          tagline: 'Cho agency và tổ chức quy mô lớn.',
          priceLabel: 'Liên hệ',
          ctaLabel: 'Liên hệ',
          features: ['Workspace không giới hạn', 'Quy tắc governance tùy chỉnh', 'Onboarding riêng', 'Hỗ trợ enterprise'],
        },
      ],
    },
    contact: {
...
export const getCopy = (language) => copy[language] || copy.en;
